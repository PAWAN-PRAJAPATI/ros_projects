...
"""autogenerated by genpy from isac/IKsrvRequest.msg. Do not edit."""
import sys
...
class IKsrvRequest(genpy.Message):
  _md5sum = "b0255036ee48d2ab6aae02ed3b772509"
  _type = "isac/IKsrvRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IKsrvRequest, self).__init__(*args, **kwds)
...
def _get_struct_3f():
    ...
    return _struct_3f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from isac/IKsrvResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class IKsrvResponse(genpy.Message):
  _md5sum = "a56790ec5944d063a1e86e682138c9c0"
  _type = "isac/IKsrvResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IKsrvResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class IKsrv(object):
  ...
  _request_class  = IKsrvRequest
  _response_class = IKsrvResponse
