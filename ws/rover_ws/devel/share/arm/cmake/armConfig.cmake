...
if("TRUE" STREQUAL "TRUE")
  set(arm_SOURCE_PREFIX /home/pawan/Desktop/UD/ROS/ws/rover_ws/src/arm)
  set(arm_DEVEL_PREFIX /home/pawan/Desktop/UD/ROS/ws/rover_ws/devel)
  set(arm_INSTALL_PREFIX "")
  set(arm_PREFIX ${arm_DEVEL_PREFIX})
else()
  set(arm_SOURCE_PREFIX "")
  set(arm_DEVEL_PREFIX "")
  set(arm_INSTALL_PREFIX /home/pawan/Desktop/UD/ROS/ws/rover_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'arm' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pawan/Desktop/UD/ROS/ws/rover_ws/src/arm/${idir}'.  ${_report}")
    endif()
...
set(arm_EXPORTED_TARGETS "arm_generate_messages_cpp;arm_generate_messages_eus;arm_generate_messages_lisp;arm_generate_messages_nodejs;arm_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${arm_dep}_FOUND)
      find_package(${arm_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${arm_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
